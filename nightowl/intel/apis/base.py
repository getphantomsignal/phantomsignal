"""
NightOwl Intel API Base — Ghost Key Plugin Architecture
...
logger = logging.getLogger("nightowl.intel.api")
...
class BaseIntelAPI(abc.ABC):
    """
    Base class for all NightOwl intelligence API integrations.

    To add a new API source:
    1. Create a new file in nightowl/intel/apis/
    ...
    def __init__(self, config):
        ...
        self.logger = logging.getLogger(f"nightowl.intel.{self.NAME}")
    ...
    def _wrap_result(
        ...
        """Wrap raw API data into NightOwl standard result format."""
        return {
            "type": result_type,
            "source": self.NAME,
            "data": data,
    ...
    async def search(self, query: str, **kwargs) -> List[Dict]:
        ...
        Returns a list of NightOwl-formatted result dicts.
        """
        ...
