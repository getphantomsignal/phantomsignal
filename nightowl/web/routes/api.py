"""NightOwl REST API — Machine-readable grid interface"""
from __future__ import annotations

from flask import Blueprint, jsonify, request
from nightowl.core.database import get_db
from nightowl.core.models import Scan, ScanResult, ScanStatus, ScanType
...
def create_scan():
    from nightowl.web.app import run_scan_async
