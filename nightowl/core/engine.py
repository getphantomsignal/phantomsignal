"""
NightOwl Core Engine — The Phantom Orchestrator
...
from nightowl.core.models import Scan, ScanResult, ScanStatus, ThreatLevel

logger = logging.getLogger("nightowl.engine")


class PhantomEngine:
    """
    The NightOwl core orchestration engine.
    ...
    async def launch_scan(self, scan_id: str) -> None:
        ...
        """
        from nightowl.scrapers.crawler import WebCrawler
        from nightowl.scrapers.port_scanner import PortScanner
        from nightowl.scrapers.tech_detector import TechDetector
        from nightowl.scrapers.api_hunter import APIHunter
        from nightowl.scrapers.dns_recon import DNSRecon
